...
class AsyncApi2x6x0Schemax(BaseModel): 
  ...
  components: Optional[Components.Components] = Field(description='''Holds a set of reusable objects for different aspects of the AsyncAPI specification. All objects defined within the components object will have no effect on the API unless they are explicitly referenced from properties outside the components object.''', default=None)
