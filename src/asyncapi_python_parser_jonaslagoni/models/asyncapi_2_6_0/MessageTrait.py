...
class MessageTrait(BaseModel): 
  schema_format: Optional[str] = Field(description='''A string containing the name of the schema format/language used to define the message payload.''', default=None, alias='''schemaFormat''')
  content_type: Optional[str] = Field(description='''The content type to use when encoding/decoding a message's payload.''', default=None, alias='''contentType''')
  headers: Optional[Union[MessageTraitHeadersObject.MessageTraitHeadersObject, bool]] = Field(description='''Schema definition of the application headers.''', default=None)
  message_id: Optional[str] = Field(description='''Unique string used to identify the message. The id MUST be unique among all messages described in the API.''', default=None, alias='''messageId''')
  correlation_id: Optional[Union[Reference.Reference, CorrelationId.CorrelationId]] = Field(description='''Definition of the correlation ID used for message tracing or matching.''', default=None, alias='''correlationId''')
  tags: Optional[List[Tag.Tag]] = Field(description='''A list of tags for logical grouping and categorization of messages.''', default=None)
