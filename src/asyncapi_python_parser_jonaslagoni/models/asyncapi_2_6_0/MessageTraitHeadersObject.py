...
class MessageTraitHeadersObject(BaseModel): 
  ...
  type: Optional[Union[JsonSchemaDraft07SchemaSimpleTypes.JsonSchemaDraft07SchemaSimpleTypes, List[JsonSchemaDraft07SchemaSimpleTypes.JsonSchemaDraft07SchemaSimpleTypes]]] = Field(description='''Schema definition of the application headers.''', default=None)
