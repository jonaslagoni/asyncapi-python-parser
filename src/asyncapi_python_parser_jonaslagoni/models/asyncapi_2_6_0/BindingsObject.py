...
class BindingsObject(BaseModel): 
  ...
  mqtt5: Optional[Any] = Field(default=None)
  kafka: Optional[Any] = Field(default=None)
  ...
  pulsar: Optional[Any] = Field(default=None)
  ...
  def unwrap_extensions(cls, data):
    ...
    known_object_properties = ['http', 'ws', 'amqp', 'amqp1', 'mqtt', 'mqtt5', 'kafka', 'anypointmq', 'nats', 'jms', 'sns', 'sqs', 'stomp', 'redis', 'ibmmq', 'solace', 'googlepubsub', 'pulsar', 'extensions']
    unknown_object_properties = [element for element in json_properties if element not in known_object_properties]
    # Ignore attempts that validate regular models, only when unknown input is used we add unwrap extensions
    if len(unknown_object_properties) == 0: 
      return data
  
    known_json_properties = ['http', 'ws', 'amqp', 'amqp1', 'mqtt', 'mqtt5', 'kafka', 'anypointmq', 'nats', 'jms', 'sns', 'sqs', 'stomp', 'redis', 'ibmmq', 'solace', 'googlepubsub', 'pulsar', 'extensions']
    extensions = {}
