...
class MessagePayloadObject: 
  def __init__(self, input: Dict):
    ...
    if 'additional_items' in input:
      self._additional_items: MessagePayloadObject | bool = input['additional_items']
    if 'items' in input:
      self._items: CoreSchemaMetaMinusSchemaObject | bool | List[MessagePayloadObject | bool] = input['items']
    ...
    if 'contains' in input:
      self._contains: MessagePayloadObject | bool = input['contains']
    ...
    if 'additional_properties' in input:
      self._additional_properties: MessagePayloadObject | bool = input['additional_properties']
    if 'definitions' in input:
      self._definitions: dict[str, MessagePayloadObject | bool] = input['definitions']
    if 'properties' in input:
      self._properties: dict[str, MessagePayloadObject | bool] = input['properties']
    if 'pattern_properties' in input:
      self._pattern_properties: dict[str, MessagePayloadObject | bool] = input['pattern_properties']
    if 'dependencies' in input:
      self._dependencies: dict[str, Any | List[str]] = input['dependencies']
    if 'property_names' in input:
      self._property_names: MessagePayloadObject | bool = input['property_names']
    if 'const' in input:
      self._const: Any = input['const']
    if 'enum' in input:
      self._enum: List[Any] = input['enum']
    self._type: JsonMinusSchemaMinusDraftMinus07MinusSchemaType = .OBJECT
    if 'format' in input:
    ...
    if 'reserved_if' in input:
      self._reserved_if: MessagePayloadObject | bool = input['reserved_if']
    if 'then' in input:
      self._then: MessagePayloadObject | bool = input['then']
    if 'reserved_else' in input:
      self._reserved_else: MessagePayloadObject | bool = input['reserved_else']
    if 'all_of' in input:
      self._all_of: List[MessagePayloadObject | bool] = input['all_of']
    if 'any_of' in input:
      self._any_of: List[MessagePayloadObject | bool] = input['any_of']
    if 'one_of' in input:
      self._one_of: List[MessagePayloadObject | bool] = input['one_of']
    if 'reserved_not' in input:
      self._reserved_not: MessagePayloadObject | bool = input['reserved_not']
    if 'discriminator' in input:
      self._discriminator: SchemaDiscriminatorObject | str = input['discriminator']
  ...
  @property
  def additional_items(self) -> MessagePayloadObject | bool:
    return self._additional_items
  @additional_items.setter
  def additional_items(self, additional_items: MessagePayloadObject | bool):
    self._additional_items = additional_items

  @property
  def items(self) -> CoreSchemaMetaMinusSchemaObject | bool | List[MessagePayloadObject | bool]:
    return self._items
  @items.setter
  def items(self, items: CoreSchemaMetaMinusSchemaObject | bool | List[MessagePayloadObject | bool]):
    self._items = items
  ...
  @property
  def contains(self) -> MessagePayloadObject | bool:
    return self._contains
  @contains.setter
  def contains(self, contains: MessagePayloadObject | bool):
  ...
  @property
  def additional_properties(self) -> MessagePayloadObject | bool:
    return self._additional_properties
  @additional_properties.setter
  def additional_properties(self, additional_properties: MessagePayloadObject | bool):
    self._additional_properties = additional_properties

  @property
  def definitions(self) -> dict[str, MessagePayloadObject | bool]:
    return self._definitions
  @definitions.setter
  def definitions(self, definitions: dict[str, MessagePayloadObject | bool]):
    self._definitions = definitions

  @property
  def properties(self) -> dict[str, MessagePayloadObject | bool]:
    return self._properties
  @properties.setter
  def properties(self, properties: dict[str, MessagePayloadObject | bool]):
    self._properties = properties

  @property
  def pattern_properties(self) -> dict[str, MessagePayloadObject | bool]:
    return self._pattern_properties
  @pattern_properties.setter
  def pattern_properties(self, pattern_properties: dict[str, MessagePayloadObject | bool]):
  ...
  @property
  def property_names(self) -> MessagePayloadObject | bool:
    return self._property_names
  @property_names.setter
  def property_names(self, property_names: MessagePayloadObject | bool):
  ...
  @property
  def reserved_if(self) -> MessagePayloadObject | bool:
    return self._reserved_if
  @reserved_if.setter
  def reserved_if(self, reserved_if: MessagePayloadObject | bool):
    self._reserved_if = reserved_if

  @property
  def then(self) -> MessagePayloadObject | bool:
    return self._then
  @then.setter
  def then(self, then: MessagePayloadObject | bool):
    self._then = then

  @property
  def reserved_else(self) -> MessagePayloadObject | bool:
    return self._reserved_else
  @reserved_else.setter
  def reserved_else(self, reserved_else: MessagePayloadObject | bool):
    self._reserved_else = reserved_else

  @property
  def all_of(self) -> List[MessagePayloadObject | bool]:
    return self._all_of
  @all_of.setter
  def all_of(self, all_of: List[MessagePayloadObject | bool]):
    self._all_of = all_of

  @property
  def any_of(self) -> List[MessagePayloadObject | bool]:
    return self._any_of
  @any_of.setter
  def any_of(self, any_of: List[MessagePayloadObject | bool]):
    self._any_of = any_of

  @property
  def one_of(self) -> List[MessagePayloadObject | bool]:
    return self._one_of
  @one_of.setter
  def one_of(self, one_of: List[MessagePayloadObject | bool]):
    self._one_of = one_of

  @property
  def reserved_not(self) -> MessagePayloadObject | bool:
    return self._reserved_not
  @reserved_not.setter
  def reserved_not(self, reserved_not: MessagePayloadObject | bool):
    self._reserved_not = reserved_not

  @property
  def discriminator(self) -> SchemaDiscriminatorObject | str:
    return self._discriminator
  @discriminator.setter
  def discriminator(self, discriminator: SchemaDiscriminatorObject | str):
  ...
  def deserialize_from_json(json_string):
    return MessagePayloadObject(**json.loads(json_string))
