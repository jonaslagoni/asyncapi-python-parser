...
from .MessageExamplesItem import MessageExamplesItem
...
class Message1: 
  def __init__(self, input: Dict):
    ...
    if 'examples' in input:
      self._examples: List[MessageExamplesItem] = input['examples']
  ...
  @property
  def examples(self) -> List[MessageExamplesItem]:
    return self._examples
  @examples.setter
  def examples(self, examples: List[MessageExamplesItem]):
