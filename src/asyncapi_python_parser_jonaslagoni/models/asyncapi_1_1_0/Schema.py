...
class Schema(BaseModel): 
  ...
  def unwrap_extensions(cls, data):
    ...
    known_object_properties = ['dollar_ref', 'format', 'title', 'description', 'default', 'multiple_of', 'maximum', 'exclusive_maximum', 'minimum', 'exclusive_minimum', 'max_length', 'min_length', 'pattern', 'max_items', 'min_items', 'unique_items', 'max_properties', 'min_properties', 'required', 'enum', 'additional_properties', 'type', 'items', 'all_of', 'one_of', 'any_of', 'reserved_not', 'properties', 'discriminator', 'read_only', 'xml', 'external_docs', 'example', 'extensions']
    unknown_object_properties = [element for element in json_properties if element not in known_object_properties]
    # Ignore attempts that validate regular models, only when unknown input is used we add unwrap extensions
    if len(unknown_object_properties) == 0: 
      return data
  
    known_json_properties = ['$ref', 'format', 'title', 'description', 'default', 'multipleOf', 'maximum', 'exclusiveMaximum', 'minimum', 'exclusiveMinimum', 'maxLength', 'minLength', 'pattern', 'maxItems', 'minItems', 'uniqueItems', 'maxProperties', 'minProperties', 'required', 'enum', 'additionalProperties', 'type', 'items', 'allOf', 'oneOf', 'anyOf', 'not', 'properties', 'discriminator', 'readOnly', 'xml', 'externalDocs', 'example', 'extensions']
    extensions = {}
