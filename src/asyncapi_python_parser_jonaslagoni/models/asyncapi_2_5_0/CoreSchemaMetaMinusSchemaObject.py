...
class CoreSchemaMetaMinusSchemaObject: 
  def __init__(self, input: Dict):
    ...
    if 'items' in input:
      self._items: CoreSchemaMetaMinusSchemaObject | bool | List[MessageOneOf1OneOf1PayloadObject.MessageOneOf1OneOf1PayloadObject | bool] = input['items']
  ...
  @property
  def items(self) -> CoreSchemaMetaMinusSchemaObject | bool | List[MessageOneOf1OneOf1PayloadObject.MessageOneOf1OneOf1PayloadObject | bool]:
    return self._items
  @items.setter
  def items(self, items: CoreSchemaMetaMinusSchemaObject | bool | List[MessageOneOf1OneOf1PayloadObject.MessageOneOf1OneOf1PayloadObject | bool]):
    self._items = items
  ...
  def deserialize_from_json(json_string):
    return CoreSchemaMetaMinusSchemaObject(**json.loads(json_string))
