...
class MessageHeadersObject: 
  def __init__(self, input: Dict):
    ...
    if 'items' in input:
      self._items: Any | List[MessagePayloadObject | bool] = input['items']
  ...
  @property
  def items(self) -> Any | List[MessagePayloadObject | bool]:
    return self._items
  @items.setter
  def items(self, items: Any | List[MessagePayloadObject | bool]):
    self._items = items
  ...
  def deserialize_from_json(json_string):
    return MessageHeadersObject(**json.loads(json_string))
