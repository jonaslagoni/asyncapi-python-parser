...
class Components: 
  def __init__(self, input: Dict):
    ...
    if 'server_variables' in input:
      self._server_variables: dict[str, Reference.Reference | ServerVariable.ServerVariable] = input['server_variables']
  ...
  @property
  def server_variables(self) -> dict[str, Reference.Reference | ServerVariable.ServerVariable]:
    return self._server_variables
  @server_variables.setter
  def server_variables(self, server_variables: dict[str, Reference.Reference | ServerVariable.ServerVariable]):
