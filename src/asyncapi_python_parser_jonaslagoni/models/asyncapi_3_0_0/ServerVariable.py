...
class ServerVariable(BaseModel): 
  ...
  description: Optional[str] = Field(description='''An optional description for the server variable. CommonMark syntax MAY be used for rich text representation.''', default=None)
