...
class BearerHttpSecurityScheme(BaseModel): 
  ...
  bearer_format: Optional[str] = Field(description='''A hint to the client to identify how the bearer token is formatted. Bearer tokens are usually generated by an authorization server, so this information is primarily for documentation purposes.''', default=None, alias='''bearerFormat''')
