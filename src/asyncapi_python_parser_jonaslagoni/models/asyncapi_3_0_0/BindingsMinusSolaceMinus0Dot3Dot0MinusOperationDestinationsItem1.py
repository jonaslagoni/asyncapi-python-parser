...
class BindingsMinusSolaceMinus0Dot3Dot0MinusOperationDestinationsItem1: 
  ...
  def deserialize_from_json(json_string):
    return BindingsMinusSolaceMinus0Dot3Dot0MinusOperationDestinationsItem1(**json.loads(json_string))
