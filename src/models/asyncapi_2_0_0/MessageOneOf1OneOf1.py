...
from .MessageOneOf1OneOf1ExamplesItem import MessageOneOf1OneOf1ExamplesItem
...
class MessageOneOf1OneOf1: 
  def __init__(self, input: Dict):
    ...
    if hasattr(input, 'examples'):
      self._examples: List[MessageOneOf1OneOf1ExamplesItem] = input['examples']
  ...
  @property
  def examples(self) -> List[MessageOneOf1OneOf1ExamplesItem]:
    return self._examples
  @examples.setter
  def examples(self, examples: List[MessageOneOf1OneOf1ExamplesItem]):
