...
from .MultiFormatSchemaElseSchemaFormatAnyOf1 import MultiFormatSchemaElseSchemaFormatAnyOf1
from .MultiFormatSchemaElseSchemaFormatAnyOf2 import MultiFormatSchemaElseSchemaFormatAnyOf2
import json
...
class AnySchemaObject: 
  def __init__(self, input: Dict):
    ...
    if hasattr(input, 'schema_format'):
      self._schema_format: str | MultiFormatSchemaElseSchemaFormatAnyOf1 | MultiFormatSchemaElseSchemaFormatAnyOf2 = input['schema_format']
  ...
  @property
  def schema_format(self) -> str | MultiFormatSchemaElseSchemaFormatAnyOf1 | MultiFormatSchemaElseSchemaFormatAnyOf2:
    return self._schema_format
  @schema_format.setter
  def schema_format(self, schema_format: str | MultiFormatSchemaElseSchemaFormatAnyOf1 | MultiFormatSchemaElseSchemaFormatAnyOf2):
