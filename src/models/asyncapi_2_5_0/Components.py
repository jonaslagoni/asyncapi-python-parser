...
class Components: 
  def __init__(self, input: Dict):
    ...
    if hasattr(input, 'server_variables'):
      self._server_variables: dict[str, Reference | ServerVariable] = input['server_variables']
  ...
  @property
  def server_variables(self) -> dict[str, Reference | ServerVariable]:
    return self._server_variables
  @server_variables.setter
  def server_variables(self, server_variables: dict[str, Reference | ServerVariable]):
